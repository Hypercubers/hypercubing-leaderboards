...
ALTER TABLE Solve ADD COLUMN auto_verify_output JSONB;

ALTER TABLE Puzzle ADD COLUMN hsc_id TEXT;
ALTER TABLE Puzzle ADD COLUMN autoverifiable BOOLEAN NOT NULL DEFAULT TRUE;
...
CREATE OR REPLACE VIEW InlinedSolve AS
    SELECT
        ...
        Puzzle.hsc_id AS puzzle_hsc_id,
        Puzzle.autoverifiable AS puzzle_autoverifiable,
